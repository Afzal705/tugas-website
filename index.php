...
<footer class="text-center text-lg-start bg-body-tertiary text-muted">
  ...
  <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
    ...
    <div class="sosmed">
      ...
      <a href="#" class="me-4 text-reset">
        <img src="img\sosmed\twitter.png" alt="Twitter">
      </a>
      <a href="#" class="me-4 text-reset">
        <img src="img\sosmed\whatsapp.png" alt="whatsapp">
      </a>
      <a href="#" class="me-4 text-reset">
        <img src="img\sosmed\instagram.png" alt="Instagram">
      </a>
      <a href="#" class="me-4 text-reset">
        <img src="img\sosmed\linkedin.png" alt="LinkedIn">
      </a>
      <a href="https://github.com/Afzal705" class="me-4 text-reset">
        <img src="img\sosmed\github.png" alt="GitHub">
      </a>
    </div>
    <!-- Right -->
  </section>
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-home me-3"></i> SURABAYA, ITATS, ID</p>
          <p>
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2021 Copyright:
    <a class="text-reset fw-bold" href="https://mdbootstrap.com/">kelompok 10 web</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
